...
const usuarios = [
    { id: 1, email: "admin@cineflow.com", passwordHash: "123.", rol: "ADMIN", nombre: "Carlos Administrador" },
    { id: 2, email: "vendedor@cineflow.com", passwordHash: "456", rol: "VENDEDOR", nombre: "Laura Taquilla" },
    { id: 3, email: "dulces@cineflow.com", passwordHash: "789", rol: "CONFITERIA", nombre: "Pedro Confitería" }
];
